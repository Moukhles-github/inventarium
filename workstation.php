...
<body>
    ...
    <div class="main-content">
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button id="btn_wrkst_crt" type="button" class="btn btn-primary">Create</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal fade" id="editwrkstmodal" tabindex="-1" role="dialog" aria-labelledby="edit_rank_modalTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                        <button id="btn_edit_wrkst" type="button" class="btn btn-primary">Edit User</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <table class="table" style="margin-top: 100px; margin-left: 100px; margin-right: 100px; width: 90%">
            ...
            <caption>List of workstations</caption>
