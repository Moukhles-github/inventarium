            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button id="btn_whouse_crt" type="button" class="btn btn-primary">Create</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal fade" id="editwhousemodal" tabindex="-1" role="dialog" aria-labelledby="edit_rank_modalTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                        <button id="btn_edit_whouse" type="button" class="btn btn-primary">Edit User</button>
                    </div>
                </div>
            </div>
        </div>
